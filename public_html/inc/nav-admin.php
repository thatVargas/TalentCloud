            ...
            <div class="nav-container nav">
                    ...
                    <ul class="navbar-right" role="menubar">
                        ...
                        <li class="top-nav--link" id="jobPostersLinkListItem" aria-hidden="true">
                            <a href="javascript:void(0)" class="hidden" id="jobPostersLink" onclick="AdminDashboardAPI.showDashboard(this);TalentCloudAPI.setNav('jobPostersLinkListItem');">Dashboard</a>
                        </li>
