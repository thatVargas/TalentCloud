...
DataAPI.talentcloudDataloaded = function(responseText,isManager){
    ...
    thisContent.salaryMin = content.salaryMin;
    thisContent.salaryMax = content.salaryMax;
    thisContent.duration = content.duration;
    thisContent.openDate = content.openDate;
    thisContent.closeDate = content.closeDate;
    thisContent.startDate = content.startDate;
    thisContent.createJobPosterHeading = content.createJobPosterHeading;
